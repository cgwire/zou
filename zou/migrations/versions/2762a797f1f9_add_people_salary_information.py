...
def upgrade():
    with op.batch_alter_table('person', schema=None) as batch_op:
        batch_op.add_column(sa.Column('position',
                                      sqlalchemy_utils.types.choice.ChoiceType(POSITION_TYPES), nullable=True))
        batch_op.add_column(sa.Column('seniority',
                                      sqlalchemy_utils.types.choice.ChoiceType(SENIORITY_TYPES), nullable=True))
        batch_op.add_column(sa.Column('daily_salary', sa.Integer(), nullable=True))
