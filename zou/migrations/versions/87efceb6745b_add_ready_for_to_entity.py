...
def upgrade():
    ...
    op.add_column('entity', sa.Column('ready_for', sqlalchemy_utils.types.uuid.UUIDType(binary=False), default=uuid.uuid4, nullable=True))
    op.create_foreign_key('fk_ready_for', 'entity', 'task_type', ['ready_for'], ['id'])
