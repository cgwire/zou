...
def upgrade():
    ...
    op.add_column('person', sa.Column('notifications_mattermost_enabled', sa.Boolean(), nullable=True))
    op.add_column('person', sa.Column('notifications_mattermost_userid', sa.String(length=60), nullable=True))
