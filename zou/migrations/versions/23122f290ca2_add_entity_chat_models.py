...
def upgrade():
    ...
    sa.Column('object_id', sqlalchemy_utils.types.uuid.UUIDType(binary=False), default=uuid.uuid4, nullable=False),
    ...
    with op.batch_alter_table('chat', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_chat_object_id'), ['object_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_chat_object_type'), ['object_type'], unique=False)
        batch_op.create_index(batch_op.f('ix_chat_person_id'), ['person_id'], unique=False)

    op.create_table('chat_message',
    sa.Column('chat_id', sqlalchemy_utils.types.uuid.UUIDType(binary=False), default=uuid.uuid4, nullable=False),
    sa.Column('person_id', sqlalchemy_utils.types.uuid.UUIDType(binary=False), default=uuid.uuid4, nullable=False),
    sa.Column('id', sqlalchemy_utils.types.uuid.UUIDType(binary=False), default=uuid.uuid4, nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    with op.batch_alter_table('chat_message', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_chat_message_person_id'), ['person_id'], unique=False)
