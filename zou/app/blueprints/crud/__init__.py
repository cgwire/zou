...
from zou.app.blueprints.crud.project import (
    ...
    ProjectTaskTypeLinksReorderResource,
    ProjectTaskStatusLinksReorderResource,
)
...
routes = [
    ...
    ("/actions/task-types/reorder", TaskTypesReorderResource),
    ("/data/task-types/<instance_id>", TaskTypeResource),
    ("/data/task-type-links", ProjectTaskTypeLinksResource),
    (
        "/actions/projects/<project_id>/task-type-links/reorder",
        ProjectTaskTypeLinksReorderResource,
    ),
    ...
    (
        "/actions/projects/<project_id>/task-status-links/reorder",
        ProjectTaskStatusLinksReorderResource,
    ),
