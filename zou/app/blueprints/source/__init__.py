...
routes = [
    ...
    ("/import/shotgun/errors/<uuid:error_id>", ShotgunImportErrorResource),
    ...
    ("/import/csv/projects/<uuid:project_id>/assets", AssetsCsvImportResource),
    ("/import/csv/projects/<uuid:project_id>/shots", ShotsCsvImportResource),
    ("/import/csv/projects/<uuid:project_id>/edits", EditsCsvImportResource),
    (
        "/import/csv/projects/<uuid:project_id>/casting",
        CastingCsvImportResource,
    ),
    (
        "/import/csv/projects/<uuid:project_id>/task-types/<uuid:task_type_id>/estimations",
        TaskTypeEstimationsCsvImportResource,
    ),
    (
        "/import/csv/projects/<uuid:project_id>/episodes/<uuid:episode_id>/task-types/<uuid:task_type_id>/estimations",
        TaskTypeEstimationsEpisodeCsvImportResource,
    ),
