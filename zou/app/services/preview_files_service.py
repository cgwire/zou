...
def set_preview_files_for_entities(entities):
    """
    Retrieve all preview files related to given entities.
    ...
    for (preview_file, task_type_id, entity_id) in preview_files:
        ...
        light_preview_file = {
            ...
            "status": str(preview_file.status).lower(),
    ...
    for entity in entities:
        ...
        try:
            ...
            preview_file = preview_file_map.get(preview_file_id, None)
                ...
                entity.update(
                    {
                        ...
                        "preview_file_annotations": preview_file[
                            "annotations"
                        ],
                        "preview_file_task_id": preview_file["task_id"],
