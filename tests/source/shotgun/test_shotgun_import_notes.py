    ...
    def load_note(self):
        self.sg_note = {
            ...
            "note_links": [
                ...
                {"type": "Version", "id": 1, "name": "SH01_Animation"},
            ],
            "updated_by": {"type": "HumanUser", "id": 1, "name": "Jhon Doe"},
            "created_at": "2016-12-05T15:06:34+01:00",
            "updated_at": "2016-12-14T10:33:03+01:00",
            "created_by": {"type": "HumanUser", "id": 1, "name": "Jhon Doe"},
            "content": "comment 01",
            "user": {"type": "HumanUser", "id": 1, "name": "John Doe"},
            "replies": [],
            "sg_status_list": "clsd",
            "type": "Note",
            "id": 1,
